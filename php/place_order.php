...
$stmt = $conn->prepare(
    "INSERT INTO orders (user_id, customer_name, customer_email, customer_phone, customer_address, total_amount, notes)
     VALUES (?, ?, ?, ?, ?, ?, ?)"
);
$stmt->bind_param('issssds', $user_id, $name, $email, $phone, $address, $total, $notes);
